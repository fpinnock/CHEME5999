%% CHEME 5999 Problem Set 3 --> Experiment 4 "Fake" Measurements 
% Generate "fake" experimental data for Experiment 1 (Eo = 5 ); 
...
x1 = 5/Eo ; x2 = 5/Eo; x3 = 5/Eo; x4 = 3/Eo; 
...
hold on
title ('EXP #4: Concentration vs. Time') 
xlabel('Time ');
...
dlmwrite('Data_EXP4.txt',Data_table,'delimiter',' ','precision',5); 
type('Data_EXP4.txt') ; 
