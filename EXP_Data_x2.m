%% CHEME 5999 Problem Set 3 --> Experiment 2 "Fake" Measurements 
% Generate "fake" experimental data for Experiment 2 (x2o =[Po] = 5/Eo & x2 = [P] = 3/Eo); 
...
x1 = 5/Eo ; x2 = 3/Eo; x3 = 5/Eo; x4 = 3/Eo; 
...
hold on
title ('EXP #2: Concentration vs. Time') 
xlabel('Time ');
...
dlmwrite('Data_EXP2.txt',Data_table,'delimiter',' ','precision',5); 
type('Data_EXP2.txt') ; 
