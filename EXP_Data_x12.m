% CHEME 5999 Problem Set 3 --> Experiment 5 "Fake" Measurements 
% Generate "fake" experimental data for Experiment 5 
%(x1o =[UGo] = 5/Eo & x1 = [UG] = 3/Eo); (x2o =[Po] = 3/Eo & x2 = [P] = 1/Eo))
...
x1 = 3/Eo ; x2 = 1/Eo; x3 = 5/Eo; x4 = 3/Eo; 
...
hold on
title ('EXP #5: Concentration vs. Time') 
xlabel('Time ');
...
dlmwrite('Data_EXP5.txt',Data_table,'delimiter',' ','precision',5); 
type('Data_EXP5.txt') ; 
