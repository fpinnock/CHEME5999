%% CHEME 5999 Problem Set 3 --> Experiment 3 "Fake" Measurements 
% Generate "fake" experimental data for Experiment 3 (x3o =[Mn2+] = 5/Eo & x3 = [P] = 3/Eo); 
...
x1 = 5/Eo ; x2 = 5/Eo; x3 = 3/Eo; x4 = 3/Eo; 
...
hold on
title ('EXP #3: Concentration vs. Time') 
xlabel('Time ');
...
dlmwrite('Data_EXP3.txt',Data_table,'delimiter',' ','precision',5); 
type('Data_EXP3.txt') ; 
